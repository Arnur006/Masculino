      ...
      emptyCart()
        const addAddTr = () =>{
          ...
          if(keyOfTable !=''){
            ...
            elPrice.textContent = (Number(elQuant.textContent)+ Number(lklk)) * Number(priceOf.textContent)
            const value = { 
              ...
              coast: (Number(elQuant.textContent)+ Number(lklk)) * Number(priceOf.textContent)
            }; 
            ...
            table.innerHTML = `  <tbody>
                               <tr>
                                 ...
                                 <td class="white left name">${nameOf.textContent}</td>
                                 <td></td>
                               ...
                               <tr class="quant_cart ${randomKey}">
                                ...
                                <button class="strelka plus">
                                 ...
                                 <td></td>
                                 <td class="white zak-td"><span class="cdpc price">${lklk * Number(priceOf.textContent)}</span>$</td>
                               </tr>
                             </tbody>`
